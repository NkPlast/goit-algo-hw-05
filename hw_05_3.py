...
def time_algorithm(algo, text, substring):
    ...
    times = timeit.repeat(setup=setup_code, stmt=stmt, globals=globals(), number=10, repeat=5)
    return min(times)

# Вивід результатів
if __name__ == '__main__':
    algorithms = ['kmp_search', 'rabin_karp_search', 'boyer_moore_search']
    text1 = u"Використання алгоритмів у бібліотеках мов програмування..."
    text2 = u"Методи та структури даних для реалізації бази даних рекомендаційної системи соціальної мережі..."
